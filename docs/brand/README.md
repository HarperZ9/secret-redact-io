...
- Product role: guarded file, fetch, write, and subprocess IO with redaction and hash-only receipts.
- Tool-specific motif: intake graph, redacted boundary, and receipt packet.
